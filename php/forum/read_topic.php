...
?>
								<tr>
									<td class="author center"><?php
										if($dnn2['lienPhoto']!='')
										{
											echo '<img src="../../upload/'.htmlentities($dnn2['lienPhoto']).'" alt="Image Perso" style="max-width:100px;max-height:100px;" />';
										}
?>										<br /><a href="profile.php?id=<?php echo $dnn2['authorid']; ?>"><?php echo $dnn2['author']; ?></a>
									</td>
									<td class="left">
										<?php if(isset($_SESSION['pseudo']) and ($_SESSION['pseudo']==$dnn2['author'] or $_SESSION['isModerateur']==4)){ ?>
										<div class="edit"><a href="edit_message.php?id=<?php echo $id; ?>&id2=<?php echo $dnn2['id2']; ?>"><img src="<?php echo $design; ?>/images/edit.png" alt="Edit" /></a>
										</div><?php } ?><div class="date">Date sent: <?php echo date('Y/m/d H:i:s' ,$dnn2['timestamp']); ?></div>
										<div class="clean"></div>
